...
public class HdfsUser implements User, Serializable {
	...
	private ArrayList<String> scanDir = new ArrayList<String>();
	...
	public void setScanDir(ArrayList<String> scanDir) {
		if (scanDir.size() < 1) {
			log.error("User " + name + " is not a memer of any scan direct");
		}
