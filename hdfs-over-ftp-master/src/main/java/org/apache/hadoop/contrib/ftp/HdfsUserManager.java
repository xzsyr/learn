...
public class HdfsUserManager extends AbstractUserManager {
	...
	private ArrayList<String> parseScanDir(String groupsLine) {
		String baseUri = HdfsOverFtpSystem.HDFS_URI;
		String[]  scanDirArray = groupsLine.split(",");
		ArrayList<String> list  = new ArrayList<String>();
		for (String str : scanDirArray) {
			list.add(baseUri+str);
		}
		return list;
	}
	...
	public synchronized User getUserByName(String userName) {
		...
		for (String str : user.getScanDir()) {
