...
public class CommonsEmailTest
{
   ...
   private int port = 25;
   private String userName = "industry_center@163.com";
   private String password = "zyytyuqing2017";
   private String to = "ikongge@163.com";
 
   public static void main(String[] args) {
	   CommonsEmailTest test =new CommonsEmailTest();
	   try {
		test.sendTextMail();
	} catch (Exception e) {
